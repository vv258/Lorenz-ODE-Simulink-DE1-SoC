// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Lorenz_FP_ip.v
...
module Lorenz_FP_ip
  ...
  assign ip_timestamp = 32'b01110001100011000111100010000100;
  ...
  Lorenz_FP_ip_dut u_Lorenz_FP_ip_dut_inst (.clk(IPCORE_CLK),  // ufix1
                                            .reset(reset),
  ...
  Lorenz_FP_ip_cop u_Lorenz_FP_ip_cop_inst (.clk(IPCORE_CLK),  // ufix1
                                            .reset(reset),
  ...
  Lorenz_FP_ip_axi4 u_Lorenz_FP_ip_axi4_inst (.reset(reset),
