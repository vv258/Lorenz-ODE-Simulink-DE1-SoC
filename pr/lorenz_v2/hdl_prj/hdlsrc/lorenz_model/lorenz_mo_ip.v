// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\lorenz_mo_ip.v
...
module lorenz_mo_ip
  ...
  wire signed [26:0] write_sigma;  // sfix27_En20
  wire signed [26:0] write_x0;  // sfix27_En20
  wire signed [26:0] write_rho;  // sfix27_En20
  wire signed [26:0] write_y0;  // sfix27_En20
  wire signed [26:0] write_beta;  // sfix27_En20
  wire signed [26:0] write_z0;  // sfix27_En20
  wire signed [26:0] write_dt;  // sfix27_En20
  ...
  assign ip_timestamp = 32'b01110001100000000001110000110111;
  ...
  lorenz_mo_ip_dut u_lorenz_mo_ip_dut_inst (.clk(IPCORE_CLK),  // ufix1
                                            .reset(reset),
                                            .dut_enable(write_axi_enable),  // ufix1
                                            .sigma(write_sigma),  // sfix27_En20
                                            .x0(write_x0),  // sfix27_En20
                                            .rho(write_rho),  // sfix27_En20
                                            .y0(write_y0),  // sfix27_En20
                                            .beta(write_beta),  // sfix27_En20
                                            .z0(write_z0),  // sfix27_En20
                                            .dt(write_dt),  // sfix27_En20
  ...
  lorenz_mo_ip_axi4 u_lorenz_mo_ip_axi4_inst (.reset(reset),
