// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\lorenz_mo_ip_dut.v
...
// -------------------------------------------------------------
// 
// Module: lorenz_mo_ip_dut
// Source Path: lorenz_mo_ip/lorenz_mo_ip_dut
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module lorenz_mo_ip_dut
  ...
  lorenz_mo_ip_src_Lorenz_FPGA_system u_lorenz_mo_ip_src_Lorenz_FPGA_system (.clk(clk),
                                                                             .clk_enable(enb),
                                                                             .reset(reset),
