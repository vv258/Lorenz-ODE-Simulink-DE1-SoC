// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\lorenz_mo_ip_rdfifo_data_classic.v
...
// -------------------------------------------------------------
// 
// Module: lorenz_mo_ip_rdfifo_data_classic
// Source Path: lorenz_mo_ip/lorenz_mo_ip_axi4/lorenz_mo_ip_axi4_module/lorenz_mo_ip_rdfifo_data/lorenz_mo_ip_rdfifo_data_classic
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module lorenz_mo_ip_rdfifo_data_classic
  ...
  lorenz_mo_ip_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                         ...
                                         u_lorenz_mo_ip_rdfifo_data_classic_ram_generic (.clk(clk),
                                                                                         .enb(enb),
                                                                                         .wr_din(In),
                                                                                         .wr_addr(w_waddr),
                                                                                         .wr_en(w_we),  // ufix1
...
endmodule  // lorenz_mo_ip_rdfifo_data_classic
