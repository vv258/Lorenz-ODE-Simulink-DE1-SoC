// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdlcoder_led_blinking\led_count_ip_rdfifo_data_classic.v
...
module led_count_ip_rdfifo_data_classic
  ...
  led_count_ip_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                         ...
                                         u_led_count_ip_rdfifo_data_classic_ram_generic (.clk(clk),
                                                                                         .enb(enb),
                                                                                         .wr_din(In),
                                                                                         .wr_addr(w_waddr),
                                                                                         .wr_en(w_we),  // ufix1
...
endmodule  // led_count_ip_rdfifo_data_classic
