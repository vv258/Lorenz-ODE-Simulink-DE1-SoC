// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Lorenz_FP_ip_rdfifo_data_classic.v
...
// -------------------------------------------------------------
// 
// Module: Lorenz_FP_ip_rdfifo_data_classic
// Source Path: Lorenz_FP_ip/Lorenz_FP_ip_axi4/Lorenz_FP_ip_axi4_module/Lorenz_FP_ip_rdfifo_data/Lorenz_FP_ip_rdfifo_data_classic
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Lorenz_FP_ip_rdfifo_data_classic
  ...
  Lorenz_FP_ip_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                           .DataWidth(32)
                                           )
                                         u_Lorenz_FP_ip_rdfifo_data_classic_ram_generic (.clk(clk),
                                                                                         .enb(enb),
                                                                                         .wr_din(In),
                                                                                         .wr_addr(w_waddr),
                                                                                         .wr_en(w_we),  // ufix1
...
endmodule  // Lorenz_FP_ip_rdfifo_data_classic
