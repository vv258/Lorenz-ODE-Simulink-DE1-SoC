// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Subsystem_ip_SimpleDualPortRAM_generic.v
...
// Source Path: Subsystem_ip/Subsystem_ip_axi4/Subsystem_ip_axi4_module/Subsystem_ip_rdfifo_data/Subsystem_ip_rdfifo_data_classic/Subsystem_ip_SimpleDualPortRAM_generic
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Subsystem_ip_SimpleDualPortRAM_generic
  ...
  always @(posedge clk)
    begin : Subsystem_ip_SimpleDualPortRAM_generic_process
      if (enb == 1'b1) begin
        if (wr_en == 1'b1) begin
          ram[wr_addr] <= wr_din;
        end
...
endmodule  // Subsystem_ip_SimpleDualPortRAM_generic
