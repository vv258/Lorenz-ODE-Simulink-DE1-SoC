// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdlcoder_led_blinking\led_count_ip_rdfifo_last_classic.v
...
// -------------------------------------------------------------
// 
// Module: led_count_ip_rdfifo_last_classic
// Source Path: led_count_ip/led_count_ip_axi4/led_count_ip_axi4_module/led_count_ip_rdfifo_last/led_count_ip_rdfifo_last_classic
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module led_count_ip_rdfifo_last_classic
  ...
  led_count_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(4),
                                             .DataWidth(1)
                                             )
                                           u_led_count_ip_rdfifo_last_classic_ram_singlebit (.clk(clk),
                                                                                             .enb(enb),
                                                                                             .wr_din(In),  // ufix1
                                                                                             .wr_addr(w_waddr),
                                                                                             .wr_en(w_we),  // ufix1
...
endmodule  // led_count_ip_rdfifo_last_classic
