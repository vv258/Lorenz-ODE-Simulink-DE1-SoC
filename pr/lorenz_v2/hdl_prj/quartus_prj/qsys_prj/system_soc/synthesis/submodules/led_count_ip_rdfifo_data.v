// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdlcoder_led_blinking\led_count_ip_rdfifo_data.v
...
module led_count_ip_rdfifo_data
  ...
  led_count_ip_rdfifo_data_classic u_led_count_ip_rdfifo_data_classic_inst (.clk(clk),
                                                                            .reset(reset),
                                                                            .enb(enb),
                                                                            .In(In),  // ufix32
...
endmodule  // led_count_ip_rdfifo_data
