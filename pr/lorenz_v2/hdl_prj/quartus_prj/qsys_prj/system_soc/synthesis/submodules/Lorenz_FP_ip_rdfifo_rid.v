// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Lorenz_FP_ip_rdfifo_rid.v
...
// -------------------------------------------------------------
// 
// Module: Lorenz_FP_ip_rdfifo_rid
// Source Path: Lorenz_FP_ip/Lorenz_FP_ip_axi4/Lorenz_FP_ip_axi4_module/Lorenz_FP_ip_rdfifo_rid
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Lorenz_FP_ip_rdfifo_rid
  ...
  Lorenz_FP_ip_rdfifo_rid_classic u_Lorenz_FP_ip_rdfifo_rid_classic_inst (.clk(clk),
                                                                          .reset(reset),
                                                                          .enb(enb),
                                                                          .In(In),  // ufix12
...
endmodule  // Lorenz_FP_ip_rdfifo_rid
