// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Lorenz_FP_ip_rdfifo_data.v
...
// -------------------------------------------------------------
// 
// Module: Lorenz_FP_ip_rdfifo_data
// Source Path: Lorenz_FP_ip/Lorenz_FP_ip_axi4/Lorenz_FP_ip_axi4_module/Lorenz_FP_ip_rdfifo_data
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Lorenz_FP_ip_rdfifo_data
  ...
  Lorenz_FP_ip_rdfifo_data_classic u_Lorenz_FP_ip_rdfifo_data_classic_inst (.clk(clk),
                                                                            .reset(reset),
                                                                            .enb(enb),
                                                                            .In(In),  // ufix32
...
endmodule  // Lorenz_FP_ip_rdfifo_data
