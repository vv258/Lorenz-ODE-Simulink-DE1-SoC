// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Lorenz_FP_ip_rdfifo_last.v
...
// -------------------------------------------------------------
// 
// Module: Lorenz_FP_ip_rdfifo_last
// Source Path: Lorenz_FP_ip/Lorenz_FP_ip_axi4/Lorenz_FP_ip_axi4_module/Lorenz_FP_ip_rdfifo_last
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Lorenz_FP_ip_rdfifo_last
  ...
  Lorenz_FP_ip_rdfifo_last_classic u_Lorenz_FP_ip_rdfifo_last_classic_inst (.clk(clk),
                                                                            .reset(reset),
                                                                            .enb(enb),
                                                                            .In(In),  // ufix1
...
endmodule  // Lorenz_FP_ip_rdfifo_last
