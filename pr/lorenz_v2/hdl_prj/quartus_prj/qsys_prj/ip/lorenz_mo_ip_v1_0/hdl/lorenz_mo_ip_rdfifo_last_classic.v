// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\lorenz_mo_ip_rdfifo_last_classic.v
...
// -------------------------------------------------------------
// 
// Module: lorenz_mo_ip_rdfifo_last_classic
// Source Path: lorenz_mo_ip/lorenz_mo_ip_axi4/lorenz_mo_ip_axi4_module/lorenz_mo_ip_rdfifo_last/lorenz_mo_ip_rdfifo_last_classic
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module lorenz_mo_ip_rdfifo_last_classic
  ...
  lorenz_mo_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(4),
                                             .DataWidth(1)
                                             )
                                           u_lorenz_mo_ip_rdfifo_last_classic_ram_singlebit (.clk(clk),
                                                                                             .enb(enb),
                                                                                             .wr_din(In),  // ufix1
                                                                                             .wr_addr(w_waddr),
                                                                                             .wr_en(w_we),  // ufix1
...
endmodule  // lorenz_mo_ip_rdfifo_last_classic
