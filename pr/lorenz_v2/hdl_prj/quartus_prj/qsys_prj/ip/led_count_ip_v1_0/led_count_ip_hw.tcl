...
# documentation
set docprefix file:///
add_documentation_link "DATASHEET" [append docprefix [get_module_property MODULE_DIRECTORY] /doc/hdlcoder_led_blinking_ip_core_report.html]

# file sets
add_fileset QUARTUS_SYNTH QUARTUS_SYNTH "" ""
set_fileset_property QUARTUS_SYNTH TOP_LEVEL led_count_ip
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file led_count_ip_src_led_counter.v VERILOG PATH hdl/led_count_ip_src_led_counter.v 
add_fileset_file led_count_ip_dut.v VERILOG PATH hdl/led_count_ip_dut.v 
add_fileset_file led_count_ip_SimpleDualPortRAM_generic.v VERILOG PATH hdl/led_count_ip_SimpleDualPortRAM_generic.v 
add_fileset_file led_count_ip_rdfifo_data_classic.v VERILOG PATH hdl/led_count_ip_rdfifo_data_classic.v 
add_fileset_file led_count_ip_rdfifo_data.v VERILOG PATH hdl/led_count_ip_rdfifo_data.v 
add_fileset_file led_count_ip_SimpleDualPortRAM_singlebit.v VERILOG PATH hdl/led_count_ip_SimpleDualPortRAM_singlebit.v 
add_fileset_file led_count_ip_rdfifo_last_classic.v VERILOG PATH hdl/led_count_ip_rdfifo_last_classic.v 
add_fileset_file led_count_ip_rdfifo_last.v VERILOG PATH hdl/led_count_ip_rdfifo_last.v 
add_fileset_file led_count_ip_rdfifo_rid_classic.v VERILOG PATH hdl/led_count_ip_rdfifo_rid_classic.v 
add_fileset_file led_count_ip_rdfifo_rid.v VERILOG PATH hdl/led_count_ip_rdfifo_rid.v 
add_fileset_file led_count_ip_axi4_module.v VERILOG PATH hdl/led_count_ip_axi4_module.v 
add_fileset_file led_count_ip_addr_decoder.v VERILOG PATH hdl/led_count_ip_addr_decoder.v 
add_fileset_file led_count_ip_axi4.v VERILOG PATH hdl/led_count_ip_axi4.v 
add_fileset_file led_count_ip.v VERILOG PATH hdl/led_count_ip.v TOP_LEVEL_FILE
...
## External Ports
# connection point GPLED
add_interface GPLED conduit end
set_interface_property GPLED associatedClock ip_clk
set_interface_property GPLED associatedReset ip_rst
set_interface_property GPLED ENABLED true
set_interface_property GPLED EXPORT_OF ""
set_interface_property GPLED PORT_NAME_MAP ""
set_interface_property GPLED CMSIS_SVD_VARIABLES ""
set_interface_property GPLED SVD_ADDRESS_GROUP ""
add_interface_port GPLED GPLED pin Output 10
