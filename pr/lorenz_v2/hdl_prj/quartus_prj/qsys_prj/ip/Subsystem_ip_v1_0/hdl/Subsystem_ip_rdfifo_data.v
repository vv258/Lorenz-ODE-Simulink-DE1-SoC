// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Subsystem_ip_rdfifo_data.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip_rdfifo_data
// Source Path: Subsystem_ip/Subsystem_ip_axi4/Subsystem_ip_axi4_module/Subsystem_ip_rdfifo_data
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Subsystem_ip_rdfifo_data
  ...
  Subsystem_ip_rdfifo_data_classic u_Subsystem_ip_rdfifo_data_classic_inst (.clk(clk),
                                                                            .reset(reset),
                                                                            .enb(enb),
                                                                            .In(In),  // ufix32
  ...
  assign relop_relop1_1 = fifo_num >= afull_num;
...
endmodule  // Subsystem_ip_rdfifo_data
