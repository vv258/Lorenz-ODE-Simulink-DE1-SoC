// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\lorenz_mo_ip_rdfifo_data.v
...
// -------------------------------------------------------------
// 
// Module: lorenz_mo_ip_rdfifo_data
// Source Path: lorenz_mo_ip/lorenz_mo_ip_axi4/lorenz_mo_ip_axi4_module/lorenz_mo_ip_rdfifo_data
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module lorenz_mo_ip_rdfifo_data
  ...
  lorenz_mo_ip_rdfifo_data_classic u_lorenz_mo_ip_rdfifo_data_classic_inst (.clk(clk),
                                                                            .reset(reset),
                                                                            .enb(enb),
                                                                            .In(In),  // ufix32
...
endmodule  // lorenz_mo_ip_rdfifo_data
