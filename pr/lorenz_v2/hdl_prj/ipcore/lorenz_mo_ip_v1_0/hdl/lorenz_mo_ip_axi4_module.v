// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\lorenz_mo_ip_axi4_module.v
...
// -------------------------------------------------------------
// 
// Module: lorenz_mo_ip_axi4_module
// Source Path: lorenz_mo_ip/lorenz_mo_ip_axi4/lorenz_mo_ip_axi4_module
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module lorenz_mo_ip_axi4_module
  ...
  lorenz_mo_ip_rdfifo_data u_lorenz_mo_ip_rdfifo_data_inst (.clk(clk),
                                                            .reset(reset),
                                                            .enb(const_1),
                                                            .In(data_read),  // ufix32
  ...
  lorenz_mo_ip_rdfifo_rid u_lorenz_mo_ip_rdfifo_rid_inst (.clk(clk),
                                                          .reset(reset),
                                                          .enb(const_1),
                                                          .In(rid_int),  // ufix12
                                                          .Push(ar_transfer),  // ufix1
  ...
  lorenz_mo_ip_rdfifo_last u_lorenz_mo_ip_rdfifo_last_inst (.clk(clk),
                                                            .reset(reset),
                                                            .enb(const_1),
                                                            .In(rlast_int),  // ufix1
                                                            .Push(ar_transfer),  // ufix1
...
endmodule  // lorenz_mo_ip_axi4_module
