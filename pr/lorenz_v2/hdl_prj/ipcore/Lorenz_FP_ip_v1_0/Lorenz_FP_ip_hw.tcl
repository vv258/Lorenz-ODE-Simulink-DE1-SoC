...
set_module_property NAME Lorenz_FP_ip
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "HDL Coder Generated IP"
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME Lorenz_FP_ip
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL Lorenz_FP_ip
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file Lorenz_FP_ip_src_Subsystem2.v VERILOG PATH hdl/Lorenz_FP_ip_src_Subsystem2.v 
add_fileset_file Lorenz_FP_ip_src_Subsystem1.v VERILOG PATH hdl/Lorenz_FP_ip_src_Subsystem1.v 
add_fileset_file Lorenz_FP_ip_src_Subsystem.v VERILOG PATH hdl/Lorenz_FP_ip_src_Subsystem.v 
add_fileset_file Lorenz_FP_ip_src_Lorenz_FPGA_system.v VERILOG PATH hdl/Lorenz_FP_ip_src_Lorenz_FPGA_system.v 
add_fileset_file Lorenz_FP_ip_dut.v VERILOG PATH hdl/Lorenz_FP_ip_dut.v 
add_fileset_file Lorenz_FP_ip_cop.v VERILOG PATH hdl/Lorenz_FP_ip_cop.v 
add_fileset_file Lorenz_FP_ip_SimpleDualPortRAM_generic.v VERILOG PATH hdl/Lorenz_FP_ip_SimpleDualPortRAM_generic.v 
add_fileset_file Lorenz_FP_ip_rdfifo_data_classic.v VERILOG PATH hdl/Lorenz_FP_ip_rdfifo_data_classic.v 
add_fileset_file Lorenz_FP_ip_rdfifo_data.v VERILOG PATH hdl/Lorenz_FP_ip_rdfifo_data.v 
add_fileset_file Lorenz_FP_ip_SimpleDualPortRAM_singlebit.v VERILOG PATH hdl/Lorenz_FP_ip_SimpleDualPortRAM_singlebit.v 
add_fileset_file Lorenz_FP_ip_rdfifo_last_classic.v VERILOG PATH hdl/Lorenz_FP_ip_rdfifo_last_classic.v 
add_fileset_file Lorenz_FP_ip_rdfifo_last.v VERILOG PATH hdl/Lorenz_FP_ip_rdfifo_last.v 
add_fileset_file Lorenz_FP_ip_rdfifo_rid_classic.v VERILOG PATH hdl/Lorenz_FP_ip_rdfifo_rid_classic.v 
add_fileset_file Lorenz_FP_ip_rdfifo_rid.v VERILOG PATH hdl/Lorenz_FP_ip_rdfifo_rid.v 
add_fileset_file Lorenz_FP_ip_axi4_module.v VERILOG PATH hdl/Lorenz_FP_ip_axi4_module.v 
add_fileset_file Lorenz_FP_ip_addr_decoder.v VERILOG PATH hdl/Lorenz_FP_ip_addr_decoder.v 
add_fileset_file Lorenz_FP_ip_axi4.v VERILOG PATH hdl/Lorenz_FP_ip_axi4.v 
add_fileset_file Lorenz_FP_ip.v VERILOG PATH hdl/Lorenz_FP_ip.v TOP_LEVEL_FILE
...
set_interface_property SW associatedClock ip_clk
set_interface_property SW associatedReset ip_rst
...
add_interface_port SW SW pin Input 10
