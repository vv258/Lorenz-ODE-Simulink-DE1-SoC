// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Lorenz_FP_ip_rdfifo_rid_classic.v
...
// -------------------------------------------------------------
// 
// Module: Lorenz_FP_ip_rdfifo_rid_classic
// Source Path: Lorenz_FP_ip/Lorenz_FP_ip_axi4/Lorenz_FP_ip_axi4_module/Lorenz_FP_ip_rdfifo_rid/Lorenz_FP_ip_rdfifo_rid_classic
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Lorenz_FP_ip_rdfifo_rid_classic
  ...
  Lorenz_FP_ip_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                         ...
                                         u_Lorenz_FP_ip_rdfifo_rid_classic_ram (.clk(clk),
                                                                                .enb(enb),
                                                                                .wr_din(In),
                                                                                .wr_addr(w_waddr),
                                                                                .wr_en(w_we),  // ufix1
...
endmodule  // Lorenz_FP_ip_rdfifo_rid_classic
