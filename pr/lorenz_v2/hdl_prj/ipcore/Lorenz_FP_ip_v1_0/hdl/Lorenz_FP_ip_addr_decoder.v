// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Lorenz_FP_ip_addr_decoder.v
...
// -------------------------------------------------------------
// 
// Module: Lorenz_FP_ip_addr_decoder
// Source Path: Lorenz_FP_ip/Lorenz_FP_ip_axi4/Lorenz_FP_ip_addr_decoder
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Lorenz_FP_ip_addr_decoder
  ...
  wire enb;
  wire decode_sel_cop_out_ready;  // ufix1
  wire const_1;  // ufix1
  ...
  wire [31:0] data_in_cop_out_ready;  // ufix32
  wire [31:0] decode_rd_cop_out_ready;  // ufix32
  reg [31:0] read_reg_ip_timestamp;  // ufix32
  wire [31:0] decode_rd_ip_timestamp;  // ufix32
  reg signed [26:0] sync_reg_z;  // sfix27_En20
  wire [31:0] data_in_z;  // ufix32
  wire [31:0] decode_rd_z;  // ufix32
  reg signed [26:0] sync_reg_y;  // sfix27_En20
  wire [31:0] data_in_y;  // ufix32
  wire [31:0] decode_rd_y;  // ufix32
  reg signed [26:0] sync_reg_x;  // sfix27_En20
  ...
  assign decode_sel_cop_out_ready = addr_sel == 14'b00000000000011;
  ...
  assign decode_sel_ip_timestamp = addr_sel == 14'b00000000000100;
  ...
  assign data_in_cop_out_ready = {31'b0, read_reg_cop_out_ready};



  assign decode_rd_cop_out_ready = (decode_sel_cop_out_ready == 1'b0 ? const_0 :
  ...
  assign decode_rd_ip_timestamp = (decode_sel_ip_timestamp == 1'b0 ? decode_rd_cop_out_ready :
  ...
  always @(posedge clk or posedge reset)
    begin : reg_z_process
      if (reset == 1'b1) begin
        sync_reg_z <= 27'sb000000000000000000000000000;
      end
      else begin
  ...
  assign data_in_z = {{5{sync_reg_z[26]}}, sync_reg_z};
  ...
  always @(posedge clk or posedge reset)
    begin : reg_y_process
      if (reset == 1'b1) begin
        sync_reg_y <= 27'sb000000000000000000000000000;
      end
      else begin
        if (enb && cop_reg_strobe) begin
          sync_reg_y <= read_y;
  ...
  assign data_in_y = {{5{sync_reg_y[26]}}, sync_reg_y};
  ...
  always @(posedge clk or posedge reset)
    begin : reg_x_process
      if (reset == 1'b1) begin
        sync_reg_x <= 27'sb000000000000000000000000000;
      end
      else begin
        if (enb && cop_reg_strobe) begin
          sync_reg_x <= read_x;
  ...
  assign data_in_x = {{5{sync_reg_x[26]}}, sync_reg_x};
...
endmodule  // Lorenz_FP_ip_addr_decoder
