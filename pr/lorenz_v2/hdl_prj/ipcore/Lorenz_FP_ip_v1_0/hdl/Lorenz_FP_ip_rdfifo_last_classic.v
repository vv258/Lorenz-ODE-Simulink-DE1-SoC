// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Lorenz_FP_ip_rdfifo_last_classic.v
...
// -------------------------------------------------------------
// 
// Module: Lorenz_FP_ip_rdfifo_last_classic
// Source Path: Lorenz_FP_ip/Lorenz_FP_ip_axi4/Lorenz_FP_ip_axi4_module/Lorenz_FP_ip_rdfifo_last/Lorenz_FP_ip_rdfifo_last_classic
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Lorenz_FP_ip_rdfifo_last_classic
  ...
  Lorenz_FP_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(4),
                                             .DataWidth(1)
                                             )
                                           u_Lorenz_FP_ip_rdfifo_last_classic_ram_singlebit (.clk(clk),
                                                                                             .enb(enb),
                                                                                             .wr_din(In),  // ufix1
                                                                                             .wr_addr(w_waddr),
                                                                                             .wr_en(w_we),  // ufix1
...
endmodule  // Lorenz_FP_ip_rdfifo_last_classic
