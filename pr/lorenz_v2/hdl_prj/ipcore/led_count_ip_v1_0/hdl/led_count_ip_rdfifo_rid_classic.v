// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdlcoder_led_blinking\led_count_ip_rdfifo_rid_classic.v
...
// -------------------------------------------------------------
// 
// Module: led_count_ip_rdfifo_rid_classic
// Source Path: led_count_ip/led_count_ip_axi4/led_count_ip_axi4_module/led_count_ip_rdfifo_rid/led_count_ip_rdfifo_rid_classic
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module led_count_ip_rdfifo_rid_classic
  ...
  led_count_ip_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                           .DataWidth(12)
                                           )
                                         u_led_count_ip_rdfifo_rid_classic_ram (.clk(clk),
                                                                                .enb(enb),
                                                                                .wr_din(In),
                                                                                .wr_addr(w_waddr),
                                                                                .wr_en(w_we),  // ufix1
...
endmodule  // led_count_ip_rdfifo_rid_classic
