// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\hdlcoder_led_blinking\led_count_ip_rdfifo_last.v
...
// -------------------------------------------------------------
// 
// Module: led_count_ip_rdfifo_last
// Source Path: led_count_ip/led_count_ip_axi4/led_count_ip_axi4_module/led_count_ip_rdfifo_last
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module led_count_ip_rdfifo_last
  ...
  led_count_ip_rdfifo_last_classic u_led_count_ip_rdfifo_last_classic_inst (.clk(clk),
                                                                            .reset(reset),
                                                                            .enb(enb),
                                                                            .In(In),  // ufix1
...
endmodule  // led_count_ip_rdfifo_last
