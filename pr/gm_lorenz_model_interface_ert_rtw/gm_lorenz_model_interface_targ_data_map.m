  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% gm_lorenz_model_interface_P.Sigma_Value
	  section.data(1).logicalSrcIdx = 2;
	  section.data(1).dtTransOffset = 0;
	
	  ;% gm_lorenz_model_interface_P.dt_Value
	  section.data(2).logicalSrcIdx = 3;
	  section.data(2).dtTransOffset = 1;
	
	  ;% gm_lorenz_model_interface_P.xinit_Value
	  section.data(3).logicalSrcIdx = 4;
	  section.data(3).dtTransOffset = 2;
	
	  ;% gm_lorenz_model_interface_P.Rho_Value
	  section.data(4).logicalSrcIdx = 5;
	  section.data(4).dtTransOffset = 3;
	
	  ;% gm_lorenz_model_interface_P.yinit_Value
	  section.data(5).logicalSrcIdx = 6;
	  section.data(5).dtTransOffset = 4;
	
	  ;% gm_lorenz_model_interface_P.Beta_Value
	  section.data(6).logicalSrcIdx = 7;
	  section.data(6).dtTransOffset = 5;
	
	  ;% gm_lorenz_model_interface_P.zinit_Value
	  ...
	  ;% gm_lorenz_model_interface_P.Reset_Value
  ...
  targMap.checksum0 = 592929170;
  targMap.checksum1 = 4127590332;
  targMap.checksum2 = 2190115721;
  targMap.checksum3 = 2284303380;
