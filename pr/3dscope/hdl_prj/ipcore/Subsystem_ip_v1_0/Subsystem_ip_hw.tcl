...
set_module_property NAME Subsystem_ip
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "HDL Coder Generated IP"
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME Subsystem_ip
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL Subsystem_ip
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file Subsystem_ip_src_Triggered_Subsystem.v VERILOG PATH hdl/Subsystem_ip_src_Triggered_Subsystem.v 
add_fileset_file Subsystem_ip_src_Triggered_Subsystem3.v VERILOG PATH hdl/Subsystem_ip_src_Triggered_Subsystem3.v 
add_fileset_file Subsystem_ip_src_Subsystem.v VERILOG PATH hdl/Subsystem_ip_src_Subsystem.v 
add_fileset_file Subsystem_ip_dut.v VERILOG PATH hdl/Subsystem_ip_dut.v 
add_fileset_file Subsystem_ip_SimpleDualPortRAM_generic.v VERILOG PATH hdl/Subsystem_ip_SimpleDualPortRAM_generic.v 
add_fileset_file Subsystem_ip_rdfifo_data_classic.v VERILOG PATH hdl/Subsystem_ip_rdfifo_data_classic.v 
add_fileset_file Subsystem_ip_rdfifo_data.v VERILOG PATH hdl/Subsystem_ip_rdfifo_data.v 
add_fileset_file Subsystem_ip_SimpleDualPortRAM_singlebit.v VERILOG PATH hdl/Subsystem_ip_SimpleDualPortRAM_singlebit.v 
add_fileset_file Subsystem_ip_rdfifo_last_classic.v VERILOG PATH hdl/Subsystem_ip_rdfifo_last_classic.v 
add_fileset_file Subsystem_ip_rdfifo_last.v VERILOG PATH hdl/Subsystem_ip_rdfifo_last.v 
add_fileset_file Subsystem_ip_rdfifo_rid_classic.v VERILOG PATH hdl/Subsystem_ip_rdfifo_rid_classic.v 
add_fileset_file Subsystem_ip_rdfifo_rid.v VERILOG PATH hdl/Subsystem_ip_rdfifo_rid.v 
add_fileset_file Subsystem_ip_axi4_module.v VERILOG PATH hdl/Subsystem_ip_axi4_module.v 
add_fileset_file Subsystem_ip_addr_decoder.v VERILOG PATH hdl/Subsystem_ip_addr_decoder.v 
add_fileset_file Subsystem_ip_axi4.v VERILOG PATH hdl/Subsystem_ip_axi4.v 
add_fileset_file Subsystem_ip.v VERILOG PATH hdl/Subsystem_ip.v TOP_LEVEL_FILE
