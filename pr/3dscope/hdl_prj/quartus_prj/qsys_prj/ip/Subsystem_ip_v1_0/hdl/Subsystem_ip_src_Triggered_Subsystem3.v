...
module Subsystem_ip_src_Triggered_Subsystem3
  ...
  assign sigma_dt_mul_temp = sigma * dt;
  assign sigma_dt_out1 = sigma_dt_mul_temp[46:20];



  assign beta_dt_mul_temp = beta * dt;
  assign beta_dt_out1 = beta_dt_mul_temp[46:20];



  assign y_dt_mul_temp = Unit_Delay1_out1 * dt;
  ...
  assign Subtract1_out1 = rho - Unit_Delay2_out1;



  assign x_dt_mul_temp = Unit_Delay_out1 * dt;
