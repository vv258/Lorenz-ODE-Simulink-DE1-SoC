...
module Subsystem_ip_addr_decoder
  ...
  assign decode_sel_z = addr_sel == 14'b00000001001011;



  assign decode_sel_y = addr_sel == 14'b00000001001010;



  assign decode_sel_x = addr_sel == 14'b00000001001001;
  ...
  assign decode_sel_CLK = addr_sel == 14'b00000001000000;
  ...
  assign decode_sel_RST = addr_sel == 14'b00000001000001;
  ...
  assign decode_sel_sigma = addr_sel == 14'b00000001000010;
  ...
  assign decode_sel_dt = addr_sel == 14'b00000001000011;
  ...
  assign decode_sel_x0 = addr_sel == 14'b00000001000100;
  ...
  assign decode_sel_rho = addr_sel == 14'b00000001000101;
  ...
  assign decode_sel_y0 = addr_sel == 14'b00000001000110;
  ...
  assign decode_sel_beta = addr_sel == 14'b00000001000111;
  ...
  assign decode_sel_z0 = addr_sel == 14'b00000001001000;
