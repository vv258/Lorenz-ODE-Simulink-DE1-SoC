// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Subsystem_ip_rdfifo_data_classic.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip_rdfifo_data_classic
// Source Path: Subsystem_ip/Subsystem_ip_axi4/Subsystem_ip_axi4_module/Subsystem_ip_rdfifo_data/Subsystem_ip_rdfifo_data_classic
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Subsystem_ip_rdfifo_data_classic
  ...
  Subsystem_ip_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                           .DataWidth(32)
                                           )
                                         u_Subsystem_ip_rdfifo_data_classic_ram_generic (.clk(clk),
                                                                                         .enb(enb),
                                                                                         .wr_din(In),
                                                                                         .wr_addr(w_waddr),
                                                                                         .wr_en(w_we),  // ufix1
...
endmodule  // Subsystem_ip_rdfifo_data_classic
