// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Subsystem_ip_rdfifo_last_classic.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip_rdfifo_last_classic
// Source Path: Subsystem_ip/Subsystem_ip_axi4/Subsystem_ip_axi4_module/Subsystem_ip_rdfifo_last/Subsystem_ip_rdfifo_last_classic
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Subsystem_ip_rdfifo_last_classic
  ...
  Subsystem_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(4),
                                             .DataWidth(1)
                                             )
                                           u_Subsystem_ip_rdfifo_last_classic_ram_singlebit (.clk(clk),
                                                                                             .enb(enb),
                                                                                             .wr_din(In),  // ufix1
                                                                                             .wr_addr(w_waddr),
                                                                                             .wr_en(w_we),  // ufix1
...
endmodule  // Subsystem_ip_rdfifo_last_classic
