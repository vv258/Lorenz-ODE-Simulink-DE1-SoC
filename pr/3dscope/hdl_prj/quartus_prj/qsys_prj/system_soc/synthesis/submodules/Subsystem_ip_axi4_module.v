// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lorenz_model\Subsystem_ip_axi4_module.v
...
// -------------------------------------------------------------
// 
// Module: Subsystem_ip_axi4_module
// Source Path: Subsystem_ip/Subsystem_ip_axi4/Subsystem_ip_axi4_module
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Subsystem_ip_axi4_module
  ...
  Subsystem_ip_rdfifo_data u_Subsystem_ip_rdfifo_data_inst (.clk(clk),
                                                            .reset(reset),
                                                            .enb(const_1),
                                                            .In(data_read),  // ufix32
  ...
  Subsystem_ip_rdfifo_rid u_Subsystem_ip_rdfifo_rid_inst (.clk(clk),
                                                          .reset(reset),
                                                          .enb(const_1),
                                                          .In(rid_int),  // ufix12
                                                          .Push(ar_transfer),  // ufix1
  ...
  Subsystem_ip_rdfifo_last u_Subsystem_ip_rdfifo_last_inst (.clk(clk),
                                                            .reset(reset),
                                                            .enb(const_1),
                                                            .In(rlast_int),  // ufix1
                                                            .Push(ar_transfer),  // ufix1
...
endmodule  // Subsystem_ip_axi4_module
